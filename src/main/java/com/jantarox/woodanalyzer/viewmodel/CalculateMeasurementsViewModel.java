...
public class CalculateMeasurementsViewModel {
    ...
    public CalculateMeasurementsViewModel(LoadedImagesModel loadedImagesModel, ImageSegmentationModel imageSegmentationModel) {
    ...
    public void calculateMeasurements() {
        ...
        runAnalyserCommandTask = new RunAnalyserCommandTask("calculate-measurements", loadedImagesModel.getSelectedImage().getSegmentationFilename());
    ...
    public boolean terminateProcess() {
        ...
        if (runAnalyserCommandTask != null && runAnalyserCommandTask.isRunning()) {
            Alert alert = new Alert(Alert.AlertType.WARNING, "The measurements calculation is still in process!\nAre you sure you want to cancel?", ButtonType.YES, ButtonType.NO);
